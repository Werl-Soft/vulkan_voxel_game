...
// *************** Descriptor Pool *********************
    ...
    bool EngineDescriptorPool::allocateDescriptorSet(const VkDescriptorSetLayout descriptorSetLayout, VkDescriptorSet &descriptor) const {
        ...
        //TODO Better descriptor set handling https://vkguide.dev/docs/extra-chapter/abstracting_descriptors/
